...
faq3_a: "Курс подходит для уровня B1 и выше. Подходит как новичкам, так и тем, кто хочет улучшить свой результат.",

faq4_q: "Сколько стоит курс?",
faq4_a: "Стоимость начинается от X сум. Оставьте заявку — мы подберём лучший вариант для вас.",

faq5_q: "Что я получу по окончании курса?",
faq5_a: "Вы получите уверенность в английском, стратегии сдачи IELTS и желаемый балл."
}
  },
  uz: {
translation: {
