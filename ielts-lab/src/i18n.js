...
teacher_10_desc:
  ...
  ru: {
    translation: {
      ...
      free_title: "<primary>Бесплатные</primary> материалы от <primary>наших преподавателей</primary> для самостоятельной подготовки",
      free_desc:
        "Видео электронные книги шаблоны и ещё больше помощи что бы помочь вам подготовить лучше",
